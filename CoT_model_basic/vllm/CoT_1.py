...
def simple_eval_with_sampling(dataset, n_gen=1, temperature=0.7, top_p=1.0, min_p=0.0, top_k=-1, best_of=1, use_beam_search=False,max_tokens=512):
        ...
        samplingParameters = SamplingParams(n=n_gen,temperature=temperature,top_p=top_p,top_k=top_k,best_of=best_of,use_beam_search=use_beam_search,max_tokens=max_tokens)
        for row in dataset:
